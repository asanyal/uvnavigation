...
/**
 * TODO: dont areas have nodes/segments?
 * Data-model of a TMC location-administrative area.<br/>
 * Used by {@link TMCLocationTable}.
 */
public final class TMCAdminArea extends TMCEntity {
    /**
     * Country-ID.
     */
    private int CID;
     ...
     */
    public static NavigableMap<Integer, TMCAdminArea> loadAll(final File aDirectory, final TMCLocationTable aLocationTable) throws IOException {
        NavigableMap<Integer, TMCAdminArea> retval = new TreeMap<Integer, TMCAdminArea>(new AdminAreaComparator());
        ...
        while (line != null) {
            ...
            line = in.readLine();
            int i = 0;
            TMCAdminArea point = new TMCAdminArea(
     ...
     */
    private static Map<Integer, Set<TMCAdminArea>> myChildAreas = new HashMap<Integer, Set<TMCAdminArea>>();
    /**
     ...
     */
    public Set<TMCAdminArea> getChildAreas() {
        Set<TMCAdminArea> areas = myChildAreas.get(getLCD());
        if (areas == null) {
            return new HashSet<TMCAdminArea>();
        }
        return areas;
    }
    ...
    public Entity generateReferenceOSM(final MemoryDataSet aOutData) {
        ...
        // Members
        Set<TMCAdminArea> children = myChildAreas.get(getLCD());
        if (children != null) {
            int i = -1;
            for (TMCAdminArea childArea : children) {
                String childName = "";
    ...
    private void addChildArea(final int aParentArea, final TMCAdminArea aAdminArea) {
        Integer parent = aAdminArea.getPOL_LCD();
        Set<TMCAdminArea> children = myChildAreas.get(parent);
        if (children == null) {
            children = new HashSet<TMCAdminArea>();
     ...
     * Compare Areas by ID.
     */
    private static final class AdminAreaComparator implements
    Comparator<Integer> {
        /**
         * {@inheritDoc}.
         */
