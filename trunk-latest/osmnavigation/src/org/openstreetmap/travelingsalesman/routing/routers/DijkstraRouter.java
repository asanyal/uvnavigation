...
/**
 * A simple Dijkstra. <b>Warning: This implementation has some known bugs!</b>
 * 
 * We assume:
 * <ul>
...
public class DijkstraRouter implements IRouter
{
            ...
            final Node aStartNode, final IVehicle aSelector)
    {
        ...
        while (!nodesToVisit.isEmpty())
        {
            ...
            System.out.println(currentNode.getUvValue());
            ...
            if (currentNode.getId() == aTargetNode.getId())
            {
                ...
                LOG.log(Level.INFO, "UV DijkstraRouter found a shortest path, reconstructing path...");
            ...
            for (RoutingStep nextStep : nextSteps)
            {
                ...
                // assert (nextStep.getStartNode().getId() ==
                // currentNode.getId())
                // :
            ...
            final Map<Long, Double> aBestDistances)
    {
        System.out.println("");
        System.out.println("");
        System.out.println("Entered Reconstruct !!!");
        ...
        while (currentNode.getId() != aStartNode.getId())
        {
            ...
            if (bestStep.getEndNode().getId() != currentNode.getId())
            {
                throw new IllegalStateException(
                        "I Dijkstra's bestStep we have a step that does not end where it should!!\n"
