...
/**
 * This metric simply calculated the travel-time of a way- segment using known
 * averages.<br/>
 * 
 * @author <a href="mailto:Marcus@Wolschon.biz">Marcus Wolschon</a>
 */
public class StaticFastestRouteMetric implements IRoutingMetric,
        ITimeRoutingMetric
{
    ...
    {
        Collection<TrafficMessage> allMessages = myTrafficMessages
                .getAllMessages(getMap());
        ...
        for (WayNode node : nodes)
        {
            ...
            for (TrafficMessage trafficMessage : allMessages)
            {
                        ...
                        && thisNode.equals(trafficMessage.getEntity()))
                {
                    ...
                    double speed = getReducedSpeed(trafficMessage,
                            aSegment.getWay());
    ...
    /**
     * Calculate the speed we move with during the given traffic obstruction.
     * 
     ...
     */
    private double getReducedSpeed(final TrafficMessage aTrafficMessage,
            final Way aWay)
    {
     ...
     * 
     * @param crossing
     *            the crossing we tage
     * @param from
     *            the way+node we come from
     * @param to
     *            the way+node we go to
     * @return a cost. Guaranteed to be >=0.
     */
    public double getCost(final Node crossing, final RoutingStep from,
            final RoutingStep to)
    {
        return 0;
    }
    ...
    private enum WayClasses
    {
        ...
        motorway_link,
        /**
         * A road that connects {@link #primary}-roads to {@link #motorway}s.
         */
        trunk,
        /**
        ...
        primary_link,
        /**
         * A road of the usual secondary road-network connecting all cities.
         */
        secondary,
        /**
        ...
        secondary_link,
        /**
         * A road of the usual tertiary road-network connecting all villages.
         */
        tertiary,
        /**
         * A road inside a city/village where people live. Usually heavily
         * speed-limited.
         */
        residential,
        /**
         * The lowest kind of road in the conventional road-network. This does
         * not denote roads that have not yet been classified.
         */
        unclassified;

        /**
         * The value to return from {@link #getFactor(String)} for an unknown
         * type of road.
         */
        public static final int UNKNOWNROADFACTOR = 100;

        /**
         * Get the factor to multiple with the length of the way to get the cost
         * of traveling it.
         * 
         * @param highway
         *            the value of the highway-attribute
     ...
     * 
     * @param aRoutingStep
     *            the step to calculate the speed for
    ...
    public double getEstimatedSpeed(final RoutingStep aRoutingStep)
    {
        ...
        int maxspeed = TrafficRuleManager.getMaxspeed(aRoutingStep.getWay(),
                this.myMap);
