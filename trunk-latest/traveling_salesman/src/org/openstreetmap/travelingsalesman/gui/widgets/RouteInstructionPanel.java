...
//    /**
//     * Panel that houses {@link #myNextStepButton} and {@link #myDistanceToNextWaypointLabel}.
//     */
...
//        this.myCurrentStepPanel.add(getNextStepButton(), BorderLayout.CENTER);
//        this.myCurrentStepPanel.setBackground(this.getBackground());
//        this.getNextStepButton().setBackground(this.getBackground());
//        this.myCurrentStepPanel.add(this.myDistanceToNextWaypointLabel, BorderLayout.SOUTH);
