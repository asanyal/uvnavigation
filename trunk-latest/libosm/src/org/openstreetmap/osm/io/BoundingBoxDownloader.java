...
import org.openstreetmap.osmosis.core.xml.v0_6.XmlDownloader;
    ...
    public IDataSet parseOsm(final IDataSet aWriteTo) {
        ...
        try {
            ...
            if (e.getMessage().indexOf("Received API HTTP response code 403") != -1) {
                ...
                org.openstreetmap.osmosis.core.xml.v0_5.XmlDownloader oldTask =
                    new org.openstreetmap.osmosis.core.xml.v0_5.XmlDownloader(this.mylon0, this.mylon1, this.mylat0, this.mylat1, oldServerBaseURL);
