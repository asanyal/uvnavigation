...
public class Tags {
    ...
    /**
     * "highway" denotes general type or road.
     * Valid values on ways:<br/>
     * <ul>
     * <li>"motorway"</li>
     * <li>"motorway_link"</li>
    ...
    /**
     * "oneway".
     * Valid values: "no", "false", "true", "yes".
     */
    ...
    /**
     * "addr:postal_code".
     * Used by {@link AdvancedAddressDBPlaceFinder} and {@link AddressDBPlaceFinder}.
     */
    ...
    /**
     * "addr:interpolation".
     * Valid values: "even", "odd", "all", "both"
     */
