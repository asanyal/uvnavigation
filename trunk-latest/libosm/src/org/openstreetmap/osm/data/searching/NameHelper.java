...
public final class NameHelper {
    ...
    public static String normalizeName(final String name) {
        ...
        .replace('-', ' ')
        .replaceAll("  ", " ")
        .replace("von", "v.")  // "Heinrich von Stefan Straﬂe" == "Heinrich v. Stefan Str"
        .replace("of", "o.")
        .replace("der", "d."); // "Platz der weiﬂen Rose" == "Platz d. weiﬂen Rose"
    }
    ...
    public static String buildNameSearchRegexp(final String lookFor) {
        return NameHelper.normalizeName(lookFor).replaceAll("[^a-zA-Z1-9‡-ˇ¿-ﬂ]", ".*") + ".*";
    }
