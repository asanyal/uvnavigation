...
public class HouseNumberFinderTest {
    ...
    public static void main(final String[] args) {
        //debug
        //String[] args = new String[] {"test", "GET", "?street=Baumeisterstraﬂe&houseno=38"};
        //String[] args = new String[] {"/home/fox/hno.osm", "Baumeisterstraﬂe", "11"};
        //String[] args = new String[] {"/home/fox/hno.osm", "Baumeisterstraﬂe", "40"};
        if (args.length != (2 + 1)) {
