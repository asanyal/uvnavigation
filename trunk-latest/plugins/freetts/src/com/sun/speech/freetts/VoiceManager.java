...
public class VoiceManager {
     ...
     *  PATCHED by Marcus Wolschon for Traveling Salesman to
     *  use the parent-classloader first.
     */
    private static final DynamicClassLoader classLoader =
        new DynamicClassLoader(new URL[0], VoiceDirectory.class.getClassLoader());
     ...
     * @throws IOException
     */
    private UniqueVector getVoiceDirectoryNamesFromFile(final String fileName) 
     ...
     * @throws IOException
     */
    private UniqueVector getVoiceDirectoryNamesFromInputStream(final InputStream is) 
            throws IOException {
